...
class WifiIoT extends StatefulWidget {
  @override
  _WifiIoTState createState() => _WifiIoTState();
}

class _WifiIoTState extends State<WifiIoT> {
        ...
        setState(() {
          ...
          htNetworks.add(
            ListTile(
              title: Text("" +
                  oNetwork.ssid! +
                  ((_htIsNetworkRegistered!.containsKey(oNetwork.ssid) && _htIsNetworkRegistered![oNetwork.ssid]!) ? " *" : "")),
  ...
  List<Widget> getButtonWidgetsForAndroid() {
    ...
    if (_isWifiAPSupported) {
      ...
      htPrimaryWidgets.add(Center(child: Text("Wifi AP probably not supported by your device")));
    }
  ...
  Widget build(BuildContext poContext) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Platform.isIOS ? Text('WifiFlutter Example iOS') : Text('WifiFlutter Example Android'),
