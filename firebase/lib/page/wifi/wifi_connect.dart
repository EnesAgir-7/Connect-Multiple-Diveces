...
class WifiConnect {
  static const MethodChannel _channel = const MethodChannel('wifi_connect');
  ...
  static Future<bool?> connect(String ssid, {bool saveNetwork = false}) async {
    final bool? connected = await _channel.invokeMethod<bool>('connect', {'ssid': ssid, 'saveNetwork': saveNetwork});
    return connected;
  }
  ...
  static Future<bool?> connectByPrefix(String ssidPrefix, {bool saveNetwork = false}) async {
    final bool? connected = await _channel.invokeMethod<bool>('prefixConnect', {'ssid': ssidPrefix, 'saveNetwork': saveNetwork});
    return connected;
  }
  ...
  static Future<bool?> connectToSecureNetwork(String ssid, String password,
      {bool isWep = false, bool isWpa3 = false, bool saveNetwork = false}) async {
  ...
  static Future<bool?> connectToSecureNetworkByPrefix(String ssidPrefix, String password,
      {bool isWep = false, bool isWpa3 = false, bool saveNetwork = false}) async {
    final bool? connected = await _channel.invokeMethod<bool>('securePrefixConnect', {
      'ssid': ssidPrefix,
      'password': password,
      'saveNetwork': saveNetwork,
      'isWep': isWep,
